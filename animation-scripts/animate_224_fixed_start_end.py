...
for i in range(20):
    ...
    x2 = 168
    y = 112
    create_video_right(video_name, height, width, channels, (x1, y), (x2, y), step)
    
    video_name = './left_{}.mp4'.format(c)
    x1 = 168
    x2 = 56
    y = 112
    create_video_left(video_name, height, width, channels, (x1, y), (x2, y), -step)
    
    video_name = './up_{}.mp4'.format(c)
    x = 112
    y1 = 168
    y2 = 56
    create_video_up(video_name, height, width, channels, (x, y1), (x, y2), -step)
    
    video_name = './down_{}.mp4'.format(c)
    x = 112
    y1 = 56
    y2 = 168
    create_video_down(video_name, height, width, channels, (x, y1), (x, y2), step)
