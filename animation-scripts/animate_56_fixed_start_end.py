...
for i in range(20):
    ...
    x2 = 42
    y = 28
    create_video_right(video_name, height, width, channels, (x1, y), (x2, y), step, l, b)
    
    video_name = './left_{}.mp4'.format(c)
    x1 = 42
    x2 = 14
    y = 28
    create_video_left(video_name, height, width, channels, (x1, y), (x2, y), -step, l, b)
    
    video_name = './up_{}.mp4'.format(c)
    x = 28
    y1 = 42
    y2 = 14
    create_video_up(video_name, height, width, channels, (x, y1), (x, y2), -step, l, b)
    
    video_name = './down_{}.mp4'.format(c)
    x = 28
    y1 = 14
    y2 = 42
    create_video_down(video_name, height, width, channels, (x, y1), (x, y2), step, l, b)
